-- Run in Supabase SQL Editor (or migrate) so the Admin Workspace can execute example SELECT queries.
-- Matches the same admin check pattern as fn_admin_run_sql (JWT role = 'admin').
